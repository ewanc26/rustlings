...
// Ohhh this is an interface! I know what those are! They are like a document to define the style of a struct.
struct Order {
    name: String,
    year: u32,
    made_by_phone: bool,
...
mod tests {
    ...
    fn your_order() {
        ...
        // okay then, let's create an order for myself.
